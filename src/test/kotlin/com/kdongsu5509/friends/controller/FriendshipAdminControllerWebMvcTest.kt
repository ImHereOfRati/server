...
class FriendshipAdminControllerWebMvcTest {
    ...
    private val owner = User(UUID.randomUUID(), "owner@example.com", "owner-nick", UserRole.NORMAL, OAuth2Provider.KAKAO, UserStatus.ACTIVE)
    private val friend = User(UUID.randomUUID(), "friend@example.com", "friend-nick", UserRole.NORMAL, OAuth2Provider.KAKAO, UserStatus.ACTIVE)
