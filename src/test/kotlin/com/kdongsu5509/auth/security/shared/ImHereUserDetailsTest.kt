...
class ImHereUserDetailsTest {
    ...
    companion object {
        ...
        const val EXPECTED_STATUS_ACTIVE = "STATUS_ACTIVE"
    ...
    fun createUserDetails_success() {
        ...
        assertThat(userDetails.authorities).containsExactly(
            SimpleGrantedAuthority(EXPECTED_ROLE_NORMAL),
            SimpleGrantedAuthority(EXPECTED_STATUS_ACTIVE),
        )
    }
