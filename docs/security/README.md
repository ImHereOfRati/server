...
| 관리자 접근 분리 | 관리자 모바일 인증은 비밀번호+TOTP+JWT로 처리하고 Admin API는 별도 권한 체인을 사용 | [admin-account.md](admin-account.md), [jwt.md](jwt.md#securityfilterchain) |
...
| 3 | [admin-account.md](admin-account.md) | 관리자 계정 등록·로그인·인가 흐름 |
