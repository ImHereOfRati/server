...
class UserRepositoryTest {
    ...
    fun findById_success() {
        ...
        // when
        val result = userRepository.findById(testUser.id)
    ...
    fun findById_null() {
        ...
        // when
        val result = userRepository.findById(notExistUserId)
    ...
    fun findByEmail_success() {
        ...
        // when
        val result = userRepository.findByEmail(TEST_EMAIL)
    ...
    fun findAll_success() {
        ...
        `when`(springDataUserRepository.findAllByStatusNot(UserStatus.WITHDRAWN, pageable)).thenReturn(slice)
        `when`(userMapper.toDomain(testUserEntity)).thenReturn(testUser)
    ...
    fun update_success() {
        ...
        // when
        userRepository.update(updatedDomainUser)
