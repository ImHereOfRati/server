...
class FriendRestrictionAdminServiceImpl(
    private val friendRestrictionRepository: FriendRestrictionRepository
) : FriendRestrictionAdminService {

    override fun findAll(pageable: Pageable): Slice<FriendRestriction> = friendRestrictionRepository.findAll(pageable)
